...
export default function ChatBubble({ userImage, userName, order }) {
    const [openDropdown, setOpenDropdown] = useState(false);
    const dropdownButton = `z-10 ${openDropdown ? "" : "hidden"} bg-white divide-y divide-gray-100 rounded-lg shadow w-40`;
    return (
        <div class="flex items-start gap-2.5 my-4 mx-10">
            <img
                src={order === 0 ? userImage : "/icon.png"}
            ...
            <div class="flex flex-col w-full max-w-[480px] leading-1.5 p-4 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl">
                <div class="flex items-center space-x-2 rtl:space-x-reverse">
                    <span class="text-sm font-semibold text-gray-900">{order === 0 ? userName : "Birdie Bot"}</span>
                    <span class="text-sm font-normal text-gray-500 dark:text-gray-400">11:46</span>
                </div>
                <p class="text-sm font-normal py-2.5 text-gray-900">That's awesome. I think our users will really appreciate the improvements. That's awesome. I think our users will really appreciate the improvements. That's awesome. I think our users will really appreciate the improvements.</p>
